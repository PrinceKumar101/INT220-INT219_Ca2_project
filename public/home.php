...
<div>
    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col  w-full text-2xl">
        <h1 class="text-3xl bg-gradient-to-br from-blue-50 to-blue-100 p-8 text-center text-blue-600">
            Hi there, How are you doing today <?= $_ENV["NAME"] ?? "No name Person" ?>
        </h1>
        <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 p-4 md:p-8 flex justify-center">
