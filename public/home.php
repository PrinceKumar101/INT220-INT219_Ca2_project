                 ...
                 <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                     ...
                     <div class="card bg-white rounded-lg overflow-hidden fade-in" style="animation-delay: 0.1s;">
                         ...
                         <div class="p-6">
                             ...
                             <button class="bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors duration-300">

                                 <a href=<?php go_to_location_if_loggedIn("index.php?page=weather", "index.php?page=login")  ?>>
                                     Check Forecast
                                 </a>
                             </button>
                         </div>
                     ...
                     <div class="card bg-white rounded-lg overflow-hidden fade-in" style="animation-delay: 0.2s;">
                         ...
                         <div class="p-6">
                             ...
                             <p class="text-gray-600 mb-4">Connect With world and share experince.</p>
                             <button class=" bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors duration-300">
                                 <a href="<?php go_to_location_if_loggedIn("index.php?page=community_forum", "index.php?page=login")  ?>">
                     ...
                     <div class="card bg-white rounded-lg overflow-hidden fade-in" style="animation-delay: 0.3s;">
                         ...
                         <div class="p-6">
                             ...
                             <button class=" bg-green-600 text-white px-4 py-2 rounded-full hover:bg-green-700 transition-colors duration-300 ">
                                 <a href='<?php go_to_location_if_loggedIn("index.php?page=talk_to_exp", "index.php?page=login")  ?>'>Start Chat</a>
                             </button>
                         </div>
                     </div>
                 </div>
