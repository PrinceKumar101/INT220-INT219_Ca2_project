<div class="bg-green-800 text-white pt-8">
  <div class="flex flex-col md:flex-row justify-center p-8 gap-12 md:gap-24 font-bold">
    <!-- Logo Section -->
    <div class="text-center md:text-left">
      <img src="./assets/images/agrilogo.jpg" alt="AgriNav Logo" class="h-[100px] w-[100px] rounded-full mx-auto md:mx-0 transition-transform duration-300 hover:scale-110 hover:rotate-6" id="footer-logo">
...
<script src="./assets/js/gsap_fotter.js"></script>