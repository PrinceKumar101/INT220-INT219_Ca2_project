<?php
$nav_links = ["Home" => "home", "About" => "about","Contact Us" => "contact", "Weather" => "weather", "Sign In" => "login"];
$nav_links_iflogged = ["Home" => "home", "About" => "about", "Contact Us" => "contact", "Weather" => "weather",  "Community" => "community_forum"];
